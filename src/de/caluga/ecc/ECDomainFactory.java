 ...
 */
public class ECDomainFactory {

    private HashMap<Integer, List<ECDomainParameters>> paramsByBitLen;

    public ECDomainFactory() {
        paramsByBitLen = new HashMap<>();
        ...
        ArrayList<ECDomainParameters> lst = new ArrayList<>();
        lst.add(p);
        paramsByBitLen.put(112, lst);


        //160 Bit
        lst = new ArrayList<>();
        p = new ECDomainParameters(new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFF", 16),
        ...
        p = new ECDomainParameters(new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16),
        ...
        paramsByBitLen.put(160, lst);

        //192 bit
        lst = new ArrayList<>();
        p = new ECDomainParameters(new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16),
        ...
        lst.add(p);
        paramsByBitLen.put(192, lst);


        //224 Bit
        lst = new ArrayList<>();
        p = new ECDomainParameters(new BigInteger("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF", 16),
        ...
        paramsByBitLen.put(224, lst);


        //256 Bit
        lst = new ArrayList<>();
        p = new ECDomainParameters(new BigInteger("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377", 16),
        ...
        p = new ECDomainParameters(new BigInteger("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF", 16),
        ...
        lst.add(p);
        paramsByBitLen.put(256, lst);

        //320Bit
        lst = new ArrayList<>();
        p = new ECDomainParameters(new BigInteger("D35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E27", 16),
        ...
        lst.add(p);
        paramsByBitLen.put(320, lst);

        //384 Bit
        lst = new ArrayList<>();
        p = new ECDomainParameters(new BigInteger("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53", 16),
        ...
        lst.add(p);
        paramsByBitLen.put(384, lst);

        //512 Bit
        lst = new ArrayList<>();
        lst = new ArrayList<>();
        p = new ECDomainParameters(new BigInteger("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA703308717D4D9B009BC66842AECDA12AE6A380E62881FF2F2D82C68528AA6056583A48F3", 16),
        ...
        lst.add(p);
        paramsByBitLen.put(512, lst);

    }


    public HashMap<Integer, List<ECDomainParameters>> getParamsByBitLen() {
        return paramsByBitLen;
    }
